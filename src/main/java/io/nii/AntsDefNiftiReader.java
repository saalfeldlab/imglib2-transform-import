...
public class AntsDefNiftiReader extends FormatReader
{
	  ...
	  // -- Internal FormatReader API methods --
		...
		protected void initFile(String id) throws FormatException, IOException
		{
			...
			//m.sizeC = (short)this.getMetadataValue( "Dimension 5" );
		}
	  
	  /* @see loci.formats.FormatReader#initFile(String) */
	  protected void origInitFile(String id) throws FormatException, IOException {
	    ...
	    if (getMetadataOptions().getMetadataLevel() != MetadataLevel.MINIMUM) {
	      ...
	      Length sizeX = new Length( new Double(1.0), UNITS.PIXEL );
	      Length sizeY = new Length( new Double(1.0), UNITS.PIXEL );
	      Length sizeZ = new Length( new Double(1.0), UNITS.PIXEL );
	      try{
		      sizeX =
